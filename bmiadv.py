...
if __name__ == '__main__':
    ...
    TOP.configure(background="#3CF2D3")
    TOP.title("BMI Calculator")
    TOP.resizable(width=False, height=False)
    LABLE = Label(TOP, bg="#cef0f1", text="Welcome to BMI Calculator", font=("Helvetica", 15, "bold"), pady=10)
    LABLE.place(x=55, y=0)
    LABLE1 = Label(TOP, bg="#cef0f1", text="     Enter Your Weight (in kg):   ", bd=10,
                   font=("Roboto", 10, "bold"), pady=5)
    LABLE1.place(x=85, y=60)
    ENTRY1 = Entry(TOP, bd=8, width=5, font="Roboto 11")
    ENTRY1.place(x=300, y=65)
    LABLE2 = Label(TOP, bg="#cef0f1", text="     Enter Your Height (in cm):   ", bd=10,
                   font=("Roboto", 10, "bold"), pady=5)
    LABLE2.place(x=85, y=145)
    ENTRY2 = Entry(TOP, bd=8, width=5, font="Roboto 11")
    ENTRY2.place(x=300, y=150)
    BUTTON = Button(bg="#F72FCF", bd=12, text="BMI", padx=33, pady=15, command=calculate_bmi,
